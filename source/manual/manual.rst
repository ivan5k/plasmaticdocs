Инструкция по эксплуатации ЧПУ Plasmatic Precision Layout
================================
...
.. list-table:: Технические характеристики ЧПУ Plasmatic Precision Layout
   ...
   * - Характеристика
     - Описание
   * - Поддерживаемые оси.
     - Четыре оси: X - 2, Y - 1, Z - 1. Ось Z работает только в ручном режиме и совместно с THC.
   ...
   * - Питание.
     - Напряжение питания 24 В при 200 мА.
   * - Рабочая температура.
     - От -10 С до 40 С.
   * - Влажность.
